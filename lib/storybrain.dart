...
import 'package:destinibosschallenge2/story.dart';

class StoryBrain {
  int storynumber = 0;
  List<Story> _storycollection = [
    Story(
  ...
  String getStory() {
    return _storycollection[storynumber].storytitle;
  }

  String getChoice1() {
    return _storycollection[storynumber].choice1;
  }

  String getChoice2() {
    return _storycollection[storynumber].choice2;
  }
